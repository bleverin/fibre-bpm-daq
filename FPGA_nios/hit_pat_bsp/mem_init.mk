...
# Memory: calibration_ram
MEM_0 := q_sys_calibration_ram
$(MEM_0)_NAME := calibration_ram
...
$(MEM_0)_START := 0x18403400
$(MEM_0)_END := 0x1840367f
$(MEM_0)_SPAN := 0x00000280
$(MEM_0)_HIERARCHICAL_PATH := calibration_ram
$(MEM_0)_WIDTH := 16
$(MEM_0)_HEX_DATA_WIDTH := 16
$(MEM_0)_ENDIANNESS := --little-endian-mem
$(MEM_0)_CREATE_LANES := 0

.PHONY: calibration_ram
calibration_ram: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym

# Memory: ddr3_ram
MEM_1 := ddr3_ram
$(MEM_1)_NAME := ddr3_ram
...
$(MEM_1)_HIERARCHICAL_PATH := ddr3_ram
$(MEM_1)_WIDTH := 32
...
$(MEM_2)_START := 0x18400000
$(MEM_2)_END := 0x18401fff
...
# Memory: ext_flash
MEM_3 := ext_flash
$(MEM_3)_NAME := ext_flash
HEX_FILES += $(MEM_INIT_DIR)/$(MEM_3).hex
MEM_INIT_INSTALL_FILES += $(MEM_INIT_INSTALL_DIR)/$(MEM_3).hex
$(MEM_3)_START := 0x14000000
$(MEM_3)_END := 0x17ffffff
$(MEM_3)_SPAN := 0x04000000
$(MEM_3)_HIERARCHICAL_PATH := ext_flash
$(MEM_3)_WIDTH := 32
$(MEM_3)_HEX_DATA_WIDTH := 8
$(MEM_3)_ENDIANNESS := --little-endian-mem
$(MEM_3)_CREATE_LANES := 0
$(MEM_3)_CFI_FLAGS := --base=$($(MEM_3)_START) --end=$($(MEM_3)_END) --reset=$(RESET_ADDRESS)
$(MEM_3)_BOOT_LOADER_FLAG := --boot="$(BOOT_LOADER_CFI)"

.PHONY: ext_flash
ext_flash: check_elf_exists $(MEM_INIT_DIR)/$(MEM_3).hex

# Memory: onchip_flash
MEM_4 := onchip_flash
$(MEM_4)_NAME := onchip_flash
$(MEM_4)_MEM_INIT_FILE_PARAM_NAME := INIT_FILENAME
...
FLASH_FILES += $(MEM_4).flash
$(MEM_4)_START := 0x18200000
$(MEM_4)_END := 0x1835ffff
$(MEM_4)_SPAN := 0x00160000
$(MEM_4)_HIERARCHICAL_PATH := onchip_flash
$(MEM_4)_WIDTH := 32
$(MEM_4)_HEX_DATA_WIDTH := 8
$(MEM_4)_ENDIANNESS := --little-endian-mem
$(MEM_4)_CREATE_LANES := 0
$(MEM_4)_CFI_FLAGS := --base=$($(MEM_4)_START) --end=$($(MEM_4)_END) --reset=$(RESET_ADDRESS)

.PHONY: onchip_flash
onchip_flash: check_elf_exists $(MEM_INIT_DIR)/$(MEM_4).hex $(HDL_SIM_DIR)/$(MEM_4).dat $(HDL_SIM_DIR)/$(MEM_4).sym $(MEM_4).flash
