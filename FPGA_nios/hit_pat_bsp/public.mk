...
SOPCINFO_FILE := D:/hit20v3/software/hit_pat/q_sys.sopcinfo
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x18403d68
SOPC_SYSID_FLAG += --sidp=0x18403d68
ELF_PATCH_FLAG  += --sidp 0x18403d68

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1728634208
SOPC_SYSID_FLAG += --timestamp=1728634208
ELF_PATCH_FLAG  += --timestamp 1728634208
...
# setting hal.stderr is debug_uart
ELF_PATCH_FLAG  += --stderr_dev debug_uart

# Slave descriptor of STDIN character-mode device. This setting is used by the 
# ALT_STDIN family of defines in system.h. none 
# setting hal.stdin is debug_uart
ELF_PATCH_FLAG  += --stdin_dev debug_uart
...
# setting hal.stdout is debug_uart
ELF_PATCH_FLAG  += --stdout_dev debug_uart
