...
set io_standard "$::GLOBAL_q_sys_mem_if_ddr3_emif_0_p0_io_standard CLASS I"
...
set ac_min_delay [ q_sys_mem_if_ddr3_emif_0_p0_round_3dp [ expr - $t(ac_output_min_delay_external) - $t(ac_output_min_delay_internal)]]
...
set ac_max_delay [ q_sys_mem_if_ddr3_emif_0_p0_round_3dp [ expr $t(ac_output_max_delay_external) + $t(ac_output_max_delay_internal)]]
...
if { ! [ info exists q_sys_mem_if_ddr3_emif_0_p0_sdc_cache ] } {
	...
	foreach { ckn_pin } $ckn_pins {
        ...
        foreach dqs_in_clock_struct $dqs_in_clocks {
        	...
        	set resync_clock ${inst}|pll0|upll_memphy|auto_generated|pll1|clk\[2\]
                ...
                set local_resync_clk [ q_sys_mem_if_ddr3_emif_0_p0_get_or_add_clock_vseries \
          		-target $resync_clock \
          		-suffix "resync_clk" \
          		-source $pll_ref_clock \
        	...
        	set tracking_clock ${inst}|pll0|upll_memphy|auto_generated|pll1|clk\[3\]
                ...
                set local_tracking_clk [ q_sys_mem_if_ddr3_emif_0_p0_get_or_add_clock_vseries \
          		-target $tracking_clock \
          		-suffix "tracking_clk" \
          		-source $pll_ref_clock \
          		-multiply_by $::GLOBAL_q_sys_mem_if_ddr3_emif_0_p0_pll_mult(PLL_AFI_HALF_CLK) \
          		-divide_by $::GLOBAL_q_sys_mem_if_ddr3_emif_0_p0_pll_div(PLL_AFI_HALF_CLK) \
          		-phase $::GLOBAL_q_sys_mem_if_ddr3_emif_0_p0_pll_phase(PLL_AFI_HALF_CLK) ]
