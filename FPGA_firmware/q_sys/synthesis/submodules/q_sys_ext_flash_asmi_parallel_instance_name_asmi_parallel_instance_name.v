...
//synthesis_resources = a_graycounter 6 lpm_compare 3 lpm_counter 4 lut 29 mux21 19 reg 254 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
(* ALTERA_ATTRIBUTE = {"SUPPRESS_DA_RULE_INTERNAL=C106"} *)
module  q_sys_ext_flash_asmi_parallel_instance_name_asmi_parallel_instance_name
	( 
	addr,
	asmi_dataoe,
	asmi_dataout,
...
`endif
	...
	reg	addr_die_diff_reg;
	wire	wire_addr_die_diff_reg_ena;
	wire	wire_addr_die_diff_reg_sclr;
	reg	addr_overdie_delay_reg;
	reg	addr_overdie_reg;
	wire	wire_addr_overdie_reg_ena;
	wire	wire_addr_overdie_reg_sclr;
	...
	wire	[3:0]wire_mux214a_dataout;
	wire	[7:0]wire_mux219a_dataout;
	wire  [7:0]   wire_scfifo13_q;
	wire  add_rollover;
	wire  addr_die_diff;
	wire  addr_overdie;
	...
	wire  load_opcode;
	wire  [9:0]  mask_prot;
	wire  [9:0]  mask_prot_add;
	wire  [9:0]  mask_prot_check;
	wire  [9:0]  mask_prot_comp_ntb;
	wire  [9:0]  mask_prot_comp_tb;
	...
	always @ ( negedge clkin_wire or  posedge reset)
		...
		else  add_rollover_reg <= (wire_read_add_cntr_q[26] | clr_read_wire2);
	// synopsys translate_off
	initial
		addr_die_diff_reg = 0;
	// synopsys translate_on
	always @ ( posedge clkin_wire or  posedge reset)
		if (reset == 1'b1) addr_die_diff_reg <= 1'b0;
		else if  (wire_addr_die_diff_reg_ena == 1'b1) 
			if (wire_addr_die_diff_reg_sclr == 1'b1) addr_die_diff_reg <= 1'b0;
			else  addr_die_diff_reg <= addr[25];
	assign
		wire_addr_die_diff_reg_ena = ((not_busy | clr_read_wire2) | add_rollover),
		wire_addr_die_diff_reg_sclr = (clr_read_wire2 | add_rollover);
	// synopsys translate_off
	initial
		addr_overdie_delay_reg = 0;
	// synopsys translate_on
	always @ ( posedge clkin_wire or  posedge reset)
		if (reset == 1'b1) addr_overdie_delay_reg <= 1'b0;
		else  addr_overdie_delay_reg <= addr_overdie;
	// synopsys translate_off
	initial
		addr_overdie_reg = 0;
	// synopsys translate_on
	always @ ( posedge clkin_wire or  posedge reset)
		if (reset == 1'b1) addr_overdie_reg <= 1'b0;
		else if  (wire_addr_overdie_reg_ena == 1'b1) 
			if (wire_addr_overdie_reg_sclr == 1'b1) addr_overdie_reg <= 1'b0;
			else  addr_overdie_reg <= addr_overdie_pos;
	assign
		wire_addr_overdie_reg_ena = (((~ do_addr_overdie) | add_rollover) | clr_read_wire2),
		wire_addr_overdie_reg_sclr = (add_rollover | clr_read_wire2);
	// synopsys translate_off
	initial
		addr_reg[0:0] = 0;
	// synopsys translate_on
	...
	always @ ( negedge clkin_wire or  posedge reset)
		...
		else  buf_empty_reg <= wire_cmpr15_aeb;
	// synopsys translate_off
	initial
		busy_delay_reg = 0;
	// synopsys translate_on
	...
	assign
		wire_end_rbyte_reg_ena = ((wire_mux2112_dataout | clr_endrbyte_wire) | addr_overdie),
	...
	always @ ( negedge clkin_wire or  posedge reset)
		...
		else  max_cnt_reg <= wire_cmpr14_aeb;
	// synopsys translate_off
	initial
		maxcnt_shift_reg = 0;
	// synopsys translate_on
	...
	assign
		wire_pgwrbuf_dataout_d = {(({7{read_bufdly}} & wire_scfifo13_q[7:1]) | ({7{(~ read_bufdly)}} & pgwrbuf_dataout[6:0])), (read_bufdly & wire_scfifo13_q[0])};
	assign
	...
	assign
		wire_pgwrbuf_quad_dataout_d = {(({4{read_bufdly}} & wire_scfifo13_q[7:4]) | ({4{(~ read_bufdly)}} & pgwrbuf_quad_dataout[3:0])), ({4{read_bufdly}} & wire_scfifo13_q[3:0])};
	assign
 ...
 & addr_reg_overdie[12])), (((not_busy & addr[11]) | (stage3_wire & quad_addr_reg[7])) | (addr_overdie & addr_reg_overdie[11])), (((not_busy & addr[10]) | (stage3_wire & quad_addr_reg[6])) | (addr_overdie & addr_reg_overdie[10])), (((not_busy & addr[9]) | (stage3_wire & quad_addr_reg[5])) | (addr_overdie & addr_reg_overdie[9])), (((not_busy & addr[8]) | (stage3_wire & quad_addr_reg[4])) | (addr_overdie & addr_reg_overdie[8])), (((not_busy & addr[7]) | (stage3_wire & quad_addr_reg[3])) | (addr_overdie & addr_reg_overdie[7])), (((not_busy & addr[6]) | (stage3_wire & quad_addr_reg[2])) | (addr_overdie & addr_reg_overdie[6])), (((not_busy & addr[5]) | (stage3_wire & quad_addr_reg[1])) | (addr_overdie & addr_reg_overdie[5])), (((not_busy & addr[4]) | (stage3_wire & quad_addr_reg[0])) | (addr_overdie & addr_reg_overdie[4])), ((({2{not_busy}} & addr[3:2]) | {2{stage3_wire}}) | ({2{addr_overdie}} & addr_reg_overdie[3:2])), (({2{not_busy}} & addr[1:0]) | ({2{addr_overdie}} & addr_reg_overdie[1:0]))};
	...
	always @ ( negedge clkin_wire or  posedge reset)
		if (reset == 1'b1) write_prot_reg <= 1'b0;
			...
			else  write_prot_reg <= ((((do_write | do_sec_erase) & (~ prot_wire[0])) & (((~ mask_prot_comp_ntb[9]) & (~ tb_wire)) | ((~ mask_prot_comp_tb[9]) & tb_wire))) | be_write_prot);
	assign
	...
	assign		wire_mux2110_dataout = (do_fast_read === 1'b1) ? dvalid_reg : dvalid_reg2;
	assign		wire_mux2111_dataout = (do_fast_read === 1'b1) ? (((((do_fast_read & end_fast_read) & (~ wire_gen_cntr_q[2])) & (~ wire_gen_cntr_q[1])) & (~ wire_gen_cntr_q[0])) | clr_read_wire2) : (((((do_read | do_fast_read) & (~ wire_gen_cntr_q[2])) & wire_gen_cntr_q[1]) & wire_gen_cntr_q[0]) | clr_read_wire2);
	assign		wire_mux2112_dataout = (do_fast_read === 1'b1) ? (((~ wire_gen_cntr_q[2]) & (~ wire_gen_cntr_q[1])) & (~ wire_gen_cntr_q[0])) : ((wire_gen_cntr_q[2] & (~ wire_gen_cntr_q[1])) & wire_gen_cntr_q[0]);
	assign		wire_mux2116_dataout = (do_write === 1'b1) ? (((~ wire_gen_cntr_q[2]) & (~ wire_gen_cntr_q[1])) & (~ wire_gen_cntr_q[0])) : ((wire_gen_cntr_q[2] & (~ wire_gen_cntr_q[1])) & wire_gen_cntr_q[0]);
	...
	assign		wire_mux214a_dataout = ((stage3_wire & ((do_write & do_memadd) | do_fast_read)) === 1'b1) ? {add_msb_quad_reg[3:0]} : {3'b110, add_msb_reg};
	assign		wire_mux219a_dataout = (do_fast_read === 1'b1) ? {read_dout_quad_reg[7:0]} : {read_dout_reg[7:0]};
	scfifo   scfifo13
	( 
	.aclr(reset),
	.almost_empty(),
	...
	defparam
		scfifo13.lpm_numwords = 258,
		scfifo13.lpm_width = 8,
		scfifo13.lpm_widthu = 9,
		scfifo13.use_eab = "ON",
		scfifo13.lpm_type = "scfifo";
	assign
		add_rollover = add_rollover_reg,
		addr_die_diff = (~ (wire_read_add_cntr_q[25] & addr_die_diff_reg)),
		addr_overdie = ((((rden_wire & (do_read | do_fast_read)) & ((addr_die_diff & wire_read_add_cntr_q[25]) | wire_read_add_cntr_q[26])) & stage4_wire) & (~ do_addr_overdie)),
		addr_overdie_pos = addr_overdie_delay_reg,
		addr_reg_overdie = wire_read_add_cntr_q[31:0],
		...
		bp0_wire = (statreg_int[2] & (~ do_polling)),
		bp1_wire = (statreg_int[3] & (~ do_polling)),
		bp2_wire = (statreg_int[4] & (~ do_polling)),
		bp3_wire = (statreg_int[6] & (~ do_polling)),
		buf_empty = buf_empty_reg,
		bulk_erase_wire = 1'b0,
		...
		clr_endrbyte_wire = wire_mux2111_dataout,
		...
		cnt_bfend_wire_in = wire_mux2116_dataout,
		data0out_wire = 1'b0,
		data_valid = data_valid_wire,
		data_valid_wire = wire_mux2110_dataout,
		...
		do_addr_overdie = addr_overdie_reg,
		do_bulk_erase = 1'b0,
		do_die_erase = 1'b0,
		do_ex4baddr = 1'b0,
		...
		do_wait_dummyclk = (do_fast_read & wire_cmpr8_aeb),
		...
		end_read_flag_status = wire_read_flag_status_cntr_q[1],
		...
		mask_prot_add = {(mask_prot[9] & addr_reg[25]), (mask_prot[8] & addr_reg[24]), (mask_prot[7] & addr_reg[23]), (mask_prot[6] & addr_reg[22]), (mask_prot[5] & addr_reg[21]), (mask_prot[4] & addr_reg[20]), (mask_prot[3] & addr_reg[19]), (mask_prot[2] & addr_reg[18]), (mask_prot[1] & addr_reg[17]), (mask_prot[0] & addr_reg[16])},
		mask_prot_check = {(mask_prot[9] ^ mask_prot_add[9]), (mask_prot[8] ^ mask_prot_add[8]), (mask_prot[7] ^ mask_prot_add[7]), (mask_prot[6] ^ mask_prot_add[6]), (mask_prot[5] ^ mask_prot_add[5]), (mask_prot[4] ^ mask_prot_add[4]), (mask_prot[3] ^ mask_prot_add[3]), (mask_prot[2] ^ mask_prot_add[2]), (mask_prot[1] ^ mask_prot_add[1]), (mask_prot[0] ^ mask_prot_add[0])},
		mask_prot_comp_ntb = {(mask_prot_check[9] | mask_prot_comp_ntb[8]), (mask_prot_check[8] | mask_prot_comp_ntb[7]), (mask_prot_check[7] | mask_prot_comp_ntb[6]), (mask_prot_check[6] | mask_prot_comp_ntb[5]), (mask_prot_check[5] | mask_prot_comp_ntb[4]), (mask_prot_check[4] | mask_prot_comp_ntb[3]), (mask_prot_check[3] | mask_prot_comp_ntb[2]), (mask_prot_check[2] | mask_prot_comp_ntb[1]), (mask_prot_check[1] | mask_prot_comp_ntb[0]), mask_prot_check[0]},
		mask_prot_comp_tb = {(mask_prot_add[9] | mask_prot_comp_tb[8]), (mask_prot_add[8] | mask_prot_comp_tb[7]), (mask_prot_add[7] | mask_prot_comp_tb[6]), (mask_prot_add[6] | mask_prot_comp_tb[5]), (mask_prot_add[5] | mask_prot_comp_tb[4]), (mask_prot_add[4] | mask_prot_comp_tb[3]), (mask_prot_add[3] | mask_prot_comp_tb[2]), (mask_prot_add[2] | mask_prot_comp_tb[1]), (mask_prot_add[1] | mask_prot_comp_tb[0]), mask_prot_add[0]},
		memadd_datain = {wire_mux214a_dataout[3:0]},
		...
		read_data_reg_in_wire = {wire_mux219a_dataout[7:0]},
		...
		st_busy_wire = ((statreg_int[0] & (((~ do_polling) | do_4baddr) | do_ex4baddr)) | ((~ statreg_int[7]) & do_polling)),
		...
		tb_wire = (statreg_int[5] & (~ do_polling)),
		...
		write_opcode = 8'b00111000,
		write_prot_true = write_prot_reg,
		write_wire = write_reg,
		wrvolatile_opcode = {8{1'b0}};
endmodule //q_sys_ext_flash_asmi_parallel_instance_name_asmi_parallel_instance_name
//VALID FILE
